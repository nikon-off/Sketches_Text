...
Процедура Расш1_УстановитьСрокОтветсвенности(Договор, Пользователь, РольИсполнителя = Неопределено) Экспорт
...
&Вместо("СписокЗначенийДопОтбораПорядкаРаспределения")
Функция Расш1_СписокЗначенийДопОтбораПорядкаРаспределения()
...
&Вместо("ВыборкаРаспределенияНаИсполнителя")
Функция Расш1_ВыборкаРаспределенияНаИсполнителя(РольИсполнителя, КартаМаршрута, Предмет, ДопОтбор)
...
&Вместо("РаспределитьНаИсполнителя")
Процедура Расш1_РаспределитьНаИсполнителя(РольИсполнителя, КартаМаршрута, Предмет, Исполнитель)
...
&Вместо("РаспределитьНачальнуюНагрузку")
Процедура Расш1_РаспределитьНачальнуюНагрузку(СтрокаТЗ)
...
&Вместо("ПерераспределениеЗадач")
Процедура Расш1_ПерераспределениеЗадач()
